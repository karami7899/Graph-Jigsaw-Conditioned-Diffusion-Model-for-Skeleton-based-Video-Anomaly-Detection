...
import yaml
from models.GiCiSAD import GiCiSAD
...
if __name__== '__main__':
    ...
    parser = argparse.ArgumentParser(description='GiCiSAD')
    ...
    if args.load_tensors:
        ...
        trainer = pl.Trainer(accelerator=args.accelerator, devices=args.devices[:1],
                             default_root_dir=args.ckpt_dir, max_epochs=1, logger=False, deterministic=True)
