...
def get_dataset_and_loader(args, split='train', validation=False):
    ...
    print(dataset.segs_meta.shape)
    print(dataset.person_keys)
    print(dataset.segs_ids.shape)
    #print(dataset.segs_data_np)
    for xx, yy, lablee, edgee in dataset:
      print(len(xx))
      print('x')
      print(xx.shape)
      print(xx)
    ...
    train_loader_iterator = iter(dataset)
    first_batch = next(train_loader_iterator)
    ...
    print('XXXX') 
    print(dataset[1025][0])
    print(dataset[1025][1])
    print(dataset[1025][2])
    print(dataset[1025][3])
